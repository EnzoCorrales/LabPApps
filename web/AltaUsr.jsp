...
<html>
    ...
    <body>
                    ...
                    <form class="col s12" id="reg-form">
                        ...
                        <div class="row">
                            <div class="input-field col s8">
                                <input id="NickIns" type="text" name="NickIns" class="validate" onblur="verificar()" required>
                        ...
                        <div class="row">
                            <div class="input-field col s8">
                                <input id="CorreoIns" type="email" name="CorreoIns" class="validate" onblur="verificar1()" required>
                        ...
                        <div class="row">
                            <div class="input-field col s8">
                                <input id="CPassIns" type="password" name="CPassIns" class="validate" minlength="6" onblur="verificar3()" required>
        ...
        <script>
            function verificar() {
                var name = $('#NickIns').val();
                $.ajax({
                    url: 'VerificarUsr',
                    type: 'post',
                    data: {name: name},
                    success: function (resultText) {
                        $('#test').html(resultText);
                    },
        ...
        <script>
            function verificar1() {
                var name = $('#CorreoIns').val();
                $.ajax({
                    url: 'VerificarMail',
                    type: 'post',
                    data: {name: name},
                    success: function (resultText) {
                        $('#test1').html(resultText);
                    },
                    error: function (resultText) {
                        $('#test1').html(resultText);
                    }
        ...
        <script>
            function verificar3() {
                var pass = $('#CPassIns').val();
                var pass1 = $('#PassIns').val();
                if(pass != pass1){
                    $('#test3').html("<i class=\"material-icons left\">warning</i>contraseñas no coinciden");
                }
                else{
                    $('#test3').html("<i class=\"material-icons left\">check</i>contraseñas coinciden");
                }
            }
        </script>
    </body>
