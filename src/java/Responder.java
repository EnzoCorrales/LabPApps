...
public class Responder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Responder2</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Responder2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("value", nomVideo);
        request.setAttribute("usr", nick);

        s.AgregarRespuesta(nick, nomVideo, nickC, comC, usuario, comentario);
        request.getRequestDispatcher("Video.jsp").include(request, response);
    }
